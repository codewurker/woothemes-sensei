 ...
 */
const o=(0,n.createElement)(r.SVG,{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},(0,n.createElement)(r.Path,{d:"M13 19h-2v-2h2v2zm0-6h-2v-2h2v2zm0-6h-2V5h2v2z"}));
 ...
 * Internal dependencies
 */
const p=e=>{let{action:t,onClose:s,students:i,studentDisplayName:p}=e;const{description:g,buttonLabel:h,errorMessage:_,isDestructive:v,sendAction:w}=((e,t,s)=>{const n=(0,l.escapeHTML)(s);return{add:{description:t>1?(0,a.sprintf)(
...
// Translators: placeholder is the student's name.
(0,a.__)("Select the course(s) you would like to reset progress from for <strong>%s</strong>:","sensei-lms"),n),buttonLabel:(0,a.__)("Reset Progress","sensei-lms"),errorMessage:e=>(0,a._n)("Unable to reset progress for this student. Please try again.","Unable to reset progress for these students. Please try again.",e.length,"sensei-lms"),sendAction:(e,t,s)=>{let{signal:n}=s;return c()({path:"/sensei-internal/v1/course-progress/batch",method:"DELETE",data:{student_ids:e,course_ids:t},signal:n})},isDestructive:!0}}[e]})(t,i.length,p),[f,y]=(0,n.useState)([]),[E,b]=(0,n.useState)(""),[C,S]=(0,n.useState)(!1),[k,x]=(0,n.useState)(!1),{getSignal:N}=(0,m/* ["default"] */.Z)(),Z=(0,n.useCallback)((async()=>{S(!0);try{await w(i,f.map((e=>e.id)),{signal:N()}),s(!0)}catch(e){N().aborted||(x(!0),S(!1))}}),[w,i,f,s,N]);return(0,n.createElement)(r.Modal,{className:"sensei-student-modal",title:(0,a.__)("Choose Course","sensei-lms"),onRequestClose:()=>s()},(0,n.createElement)(n.RawHTML,null,g),(0,n.createElement)(d/* ["default"] */.Z,{iconRight:o/* ["default"] */.Z,onChange:e=>b(e),placeholder:(0,a.__)("Search courses","sensei-lms"),value:E}),(0,n.createElement)(u/* ["default"] */.Z,{searchQuery:E,onChange:e=>{y(e)}}),k&&(0,n.createElement)(r.Notice,{status:"error",isDismissible:!1,className:"sensei-student-modal__notice"},_(i)),(0,n.createElement)("div",{className:"sensei-student-modal__action"},(0,n.createElement)(r.Button,{className:"sensei-student-modal__action",variant:v?"":"primary",onClick:()=>Z(),disabled:C||0===f.length,isDestructive:v},C&&(0,n.createElement)(r.Spinner,null),h)))};
/**
...
/* harmony import */var e=s(69307),t=s(55609),n=s(82857),r=s(92694),o=s(65736),a=s(9240);
/* harmony import */
/**
 * WordPress dependencies
 */
 ...
 */
const l=s=>{let{studentId:l,studentName:i,studentDisplayName:c}=s;const[u,d]=(0,e.useState)(""),[m,p]=(0,e.useState)(!1),g=e=>{e&&window.location.reload(),p(!1)},h=[{title:(0,o.__)("Add to Course","sensei-lms"),onClick:()=>v()},{title:(0,o.__)("Remove from Course","sensei-lms"),onClick:()=>w()},{title:(0,o.__)("Reset Progress","sensei-lms"),onClick:()=>f()},{title:(0,o.__)("Grading","sensei-lms"),onClick:()=>window.open(`admin.php?page=sensei_grading&view=ungraded&s=${i}`,"_self")}],_=(0,r.applyFilters)("senseiStudentActionMenuControls",h,d,p),v=()=>{d("add"),p(!0)},w=()=>{d("remove"),p(!0)},f=()=>{d("reset-progress"),p(!0)},y=(0,e.createElement)(a/* ["default"] */.Z,{action:u,onClose:g,students:[l],studentDisplayName:c}),E=(0,r.applyFilters)("senseiStudentBulkActionModal",y,u,g,[l],c);return(0,e.createElement)(e.Fragment,null,(0,e.createElement)(t.DropdownMenu,{icon:n/* ["default"] */.Z,label:(0,o.__)("Select an action","sensei-lms"),controls:_}),m&&E)};Array.from(document.getElementsByClassName("student-action-menu")).forEach((t=>{var s,n,r;(0,e.render)((0,e.createElement)(l,{studentId:null==t||null===(s=t.dataset)||void 0===s?void 0:s.userId,studentName:null==t||null===(n=t.dataset)||void 0===n?void 0:n.userName,studentDisplayName:null==t||null===(r=t.dataset)||void 0===r?void 0:r.userDisplayName}),t)}))})()})
/******/();
 ...
 * Internal Dependencies
 */
const g=(e,t)=>{"function"==typeof t&&t(e)},b=({config:e})=>{const[t,n]=(0,i.useState)(0),[s,b]=(0,i.useState)(null),[y,w]=(0,i.useState)(e.isMinimized??!1),[x,k]=(0,i.useState)(null),[Z,_]=(0,i.useState)(!1),C=(0,i.useRef)(null),S=(0,o/* .useMobileBreakpoint */._z)(),O=e.steps.length-1,j=e.steps[t].referenceElements?.[S?"mobile":"desktop"]||null,E=j?document.querySelector(j):null;(0,i.useEffect)((()=>{e.isMinimized&&w(!0)}),[e.isMinimized]);const F=(0,i.useCallback)((()=>!1!==e.options?.effects?.arrowIndicator&&!(!E||y||!Z)),[e.options?.effects?.arrowIndicator,y,E,Z]),z=(0,i.useCallback)((()=>!!e.options?.effects?.spotlight&&!y),[e.options?.effects?.spotlight,y]),q=(0,i.useCallback)((()=>!(z()||!e.options?.effects?.overlay)&&!y),[e.options?.effects?.overlay,y,z]),T=(0,i.useCallback)((n=>()=>{e.closeHandler(e.steps,t,n)}),[e,t]),P=(0,i.useCallback)((()=>{O>t&&n(t+1),g(t,e.options?.callbacks?.onNextStep)}),[e.options?.callbacks?.onNextStep,t,O]),M=(0,i.useCallback)((()=>{t&&n(t-1),g(t,e.options?.callbacks?.onPreviousStep)}),[e.options?.callbacks?.onPreviousStep,t]),R=(0,i.useCallback)((r=>{n(r),g(t,e.options?.callbacks?.onGoToStep)}),[e.options?.callbacks?.onGoToStep,t]),A=(0,i.useCallback)((()=>{w(!0),g(t,e.options?.callbacks?.onMinimize)}),[e.options?.callbacks?.onMinimize,t]),I=(0,i.useCallback)((()=>{w(!1),g(t,e.options?.callbacks?.onMaximize)}),[e.options?.callbacks?.onMaximize,t]),{styles:N,attributes:B,update:L}=(0,c/* .usePopper */.D)(E,x,{strategy:"fixed",placement:e?.placement??"bottom",modifiers:[{name:"preventOverflow",options:{rootBoundary:"document",padding:16}},{name:"arrow",options:{padding:12}},{name:"offset",options:{offset:[0,F()?12:10]}},{name:"flip",options:{fallbackPlacements:["top","left","right"]}},(0,i.useMemo)((()=>(0,d/* .liveResizeModifier */._)(e.options?.effects?.liveResize)),[e.options?.effects?.liveResize]),...e.options?.popperModifiers||[]]}),D=!y&&E&&Z?{style:N?.popper,...B?.popper}:null,H=!y&&E&&Z?{style:N?.arrow,...B?.arrow}:null;
/*
...
E?(_(!1),L&&L().then((()=>_(!0))).catch((()=>_(!0)))):_(!0)}),[L,E]),(0,i.useEffect)((()=>{E&&e.options?.effects?.autoScroll&&E.scrollIntoView(e.options.effects.autoScroll)}),[e.options?.effects?.autoScroll,E]);const V=a()("tour-kit-frame",S?"is-mobile":"is-desktop",{"is-visible":Z},(0,l/* .classParser */.s)(e.options?.classNames));return(0,u/* ["default"] */.Z)(t,e.options?.callbacks?.onStepViewOnce),(0,r.jsxs)(r.Fragment,{children:[(0,r.jsx)(f/* ["default"] */.Z,{onMinimize:A,onDismiss:T,onNextStepProgression:P,onPreviousStepProgression:M,tourContainerRef:C,isMinimized:y}),(0,r.jsxs)("div",{className:V,ref:C,children:[q()&&(0,r.jsx)(m/* ["default"] */.Z,{visible:!0}),z()&&(0,r.jsx)(h/* ["default"] */.Z,{referenceElement:E,liveResize:e.options?.effects?.liveResize||{},...e.options?.effects?.spotlight||{}}),(0,r.jsxs)("div",{className:"tour-kit-frame__container",ref:k,...D,children:[F()&&(0,r.jsx)("div",{className:"tour-kit-frame__arrow","data-popper-arrow":!0,...H}),y?(0,r.jsx)(p/* ["default"] */.Z,{config:e,steps:e.steps,currentStepIndex:t,onMaximize:I,onDismiss:T}):(0,r.jsx)(v/* ["default"] */.Z,{config:e,steps:e.steps,currentStepIndex:t,onMinimize:A,onDismiss:T,onNextStep:P,onPreviousStep:M,onGoToStep:R,setInitialFocusedElement:b})]})]})]})}}
...
/* harmony import */ // eslint-disable-next-line import/no-unused-modules
/* harmony default export */const f={name:"arrow",enabled:!0,phase:"main",fn:function(e){var t,n=e.state,i=e.name,f=e.options,p=n.elements.arrow,m=n.modifiersData.popperOffsets,h=(0,r/* ["default"] */.Z)(n.placement),v=(0,a/* ["default"] */.Z)(h),g=[d/* .left */.t$,d/* .right */.F2].indexOf(h)>=0?"height":"width";if(p&&m){var b=function(e,t){return e="function"==typeof e?e(Object.assign({},t.rects,{placement:t.placement})):e,(0,u/* ["default"] */.Z)("number"!=typeof e?e:(0,l/* ["default"] */.Z)(e,d/* .basePlacements */.mv))}(f.padding,n),y=(0,o/* ["default"] */.Z)(p),w="y"===v?d/* .top */.we:d/* .left */.t$,x="y"===v?d/* .bottom */.I:d/* .right */.F2,k=n.rects.reference[g]+n.rects.reference[v]-m[v]-n.rects.popper[g],Z=m[v]-n.rects.reference[v],_=(0,s/* ["default"] */.Z)(p),C=_?"y"===v?_.clientHeight||0:_.clientWidth||0:0,S=k/2-Z/2,O=b[w],j=C-y[g]-b[x],E=C/2-y[g]/2+S,F=(0,c/* .within */.u)(O,E,j),z=v;n.modifiersData[i]=((t={})[z]=F,t.centerOffset=F-E,t)}},effect:function(e){var t=e.state,n=e.options.element,r=void 0===n?"[data-popper-arrow]":n;null!=r&&("string"!=typeof r||(r=t.elements.popper.querySelector(r)))&&(0,i/* ["default"] */.Z)(t.elements.popper,r)&&(t.elements.arrow=r);// CSS selector
...
/* harmony import */function f(e){var t,n=e.popper,c=e.popperRect,u=e.placement,f=e.variation,p=e.offsets,m=e.position,h=e.gpuAcceleration,v=e.adaptive,g=e.roundOffsets,b=e.isFixed,y=p.x,w=void 0===y?0:y,x=p.y,k=void 0===x?0:x,Z="function"==typeof g?g({x:w,y:k}):{x:w,y:k};w=Z.x,k=Z.y;var _=p.hasOwnProperty("x"),C=p.hasOwnProperty("y"),S=r/* .left */.t$,O=r/* .top */.we,j=window;if(v){var E=(0,o/* ["default"] */.Z)(n),F="clientHeight",z="clientWidth";if(E===(0,i/* ["default"] */.Z)(n)&&(E=(0,s/* ["default"] */.Z)(n),"static"!==(0,a/* ["default"] */.Z)(E).position&&"absolute"===m&&(F="scrollHeight",z="scrollWidth")),u===r/* .top */.we||(u===r/* .left */.t$||u===r/* .right */.F2)&&f===r/* .end */.ut)O=r/* .bottom */.I,k-=(b&&E===j&&j.visualViewport?j.visualViewport.height:// $FlowFixMe[prop-missing]
E[F])-c.height,k*=h?1:-1;if(u===r/* .left */.t$||(u===r/* .top */.we||u===r/* .bottom */.I)&&f===r/* .end */.ut)S=r/* .right */.F2,w-=(b&&E===j&&j.visualViewport?j.visualViewport.width:// $FlowFixMe[prop-missing]
E[z])-c.width,w*=h?1:-1}var q,T=Object.assign({position:m},v&&d),P=!0===g?// Round the offsets to the nearest suitable subpixel based on the DPR.
// Zooming can change the DPR, but it seems to report a value that will
// cleanly divide the values into the appropriate subpixels.
function(e){var t=e.x,n=e.y,r=window.devicePixelRatio||1;return{x:(0,l/* .round */.NM)(t*r)/r||0,y:(0,l/* .round */.NM)(n*r)/r||0}}({x:w,y:k}):{x:w,y:k};return w=P.x,k=P.y,h?Object.assign({},T,((q={})[O]=C?"0":"",q[S]=_?"0":"",q.transform=(j.devicePixelRatio||1)<=1?"translate("+w+"px, "+k+"px)":"translate3d("+w+"px, "+k+"px, 0)",q)):Object.assign({},T,((t={})[O]=C?k+"px":"",t[S]=_?w+"px":"",t.transform="",t))}// eslint-disable-next-line import/no-unused-modules
...
/* harmony import */ // eslint-disable-next-line import/no-unused-modules
/* harmony default export */const l={name:"flip",enabled:!0,phase:"main",fn:function(e){var t=e.state,n=e.options,l=e.name;if(!t.modifiersData[l]._skip){for(var d=n.mainAxis,f=void 0===d||d,p=n.altAxis,m=void 0===p||p,h=n.fallbackPlacements,v=n.padding,g=n.boundary,b=n.rootBoundary,y=n.altBoundary,w=n.flipVariations,x=void 0===w||w,k=n.allowedAutoPlacements,Z=t.options.placement,_=(0,o/* ["default"] */.Z)(Z),C=h||(_===Z||!x?[(0,r/* ["default"] */.Z)(Z)]:
// eslint-disable-next-line import/no-unused-modules
function(e){if((0,o/* ["default"] */.Z)(e)===c/* .auto */.d7)return[];var t=(0,r/* ["default"] */.Z)(e);return[(0,i/* ["default"] */.Z)(e),t,(0,i/* ["default"] */.Z)(t)]}(Z)),S=[Z].concat(C).reduce((function(e,n){return e.concat((0,o/* ["default"] */.Z)(n)===c/* .auto */.d7?(0,a/* ["default"] */.Z)(t,{placement:n,boundary:g,rootBoundary:b,padding:v,flipVariations:x,allowedAutoPlacements:k}):n)}),[]),O=t.rects.reference,j=t.rects.popper,E=new Map,F=!0,z=S[0],q=0;q<S.length;q++){var T=S[q],P=(0,o/* ["default"] */.Z)(T),M=(0,u/* ["default"] */.Z)(T)===c/* .start */.BL,R=[c/* .top */.we,c/* .bottom */.I].indexOf(P)>=0,A=R?"width":"height",I=(0,s/* ["default"] */.Z)(t,{placement:T,boundary:g,rootBoundary:b,altBoundary:y,padding:v}),N=R?M?c/* .right */.F2:c/* .left */.t$:M?c/* .bottom */.I:c/* .top */.we;O[A]>j[A]&&(N=(0,r/* ["default"] */.Z)(N));var B=(0,r/* ["default"] */.Z)(N),L=[];if(f&&L.push(I[P]<=0),m&&L.push(I[N]<=0,I[B]<=0),L.every((function(e){return e}))){z=T,F=!1;break}E.set(T,L)}if(F)for(
...
/* harmony import */ // eslint-disable-next-line import/no-unused-modules
/* harmony default export */const m={name:"preventOverflow",enabled:!0,phase:"main",fn:function(e){var t=e.state,n=e.options,m=e.name,h=n.mainAxis,v=void 0===h||h,g=n.altAxis,b=void 0!==g&&g,y=n.boundary,w=n.rootBoundary,x=n.altBoundary,k=n.padding,Z=n.tether,_=void 0===Z||Z,C=n.tetherOffset,S=void 0===C?0:C,O=(0,l/* ["default"] */.Z)(t,{boundary:y,rootBoundary:w,padding:k,altBoundary:x}),j=(0,o/* ["default"] */.Z)(t.placement),E=(0,d/* ["default"] */.Z)(t.placement),F=!E,z=(0,i/* ["default"] */.Z)(j),q=(0,s/* ["default"] */.Z)(z),T=t.modifiersData.popperOffsets,P=t.rects.reference,M=t.rects.popper,R="function"==typeof S?S(Object.assign({},t.rects,{placement:t.placement})):S,A="number"==typeof R?{mainAxis:R,altAxis:R}:Object.assign({mainAxis:0,altAxis:0},R),I=t.modifiersData.offset?t.modifiersData.offset[t.placement]:null,N={x:0,y:0};if(T){if(v){var B,L="y"===z?r/* .top */.we:r/* .left */.t$,D="y"===z?r/* .bottom */.I:r/* .right */.F2,H="y"===z?"height":"width",V=T[z],$=V+O[L],W=V-O[D],Q=_?-M[H]/2:0,G=E===r/* .start */.BL?P[H]:M[H],U=E===r/* .start */.BL?-M[H]:-P[H],K=t.elements.arrow,X=_&&K?(0,c/* ["default"] */.Z)(K):{width:0,height:0},Y=t.modifiersData["arrow#persistent"]?t.modifiersData["arrow#persistent"].padding:(0,f/* ["default"] */.Z)(),J=Y[L],ee=Y[D],te=(0,a/* .within */.u)(0,P[H],X[H]),ne=F?P[H]/2-Q-te-J-A.mainAxis:G-te-J-A.mainAxis,re=F?-P[H]/2+Q+te+ee+A.mainAxis:U+te+ee+A.mainAxis,oe=t.elements.arrow&&(0,u/* ["default"] */.Z)(t.elements.arrow),ie=oe?"y"===z?oe.clientTop||0:oe.clientLeft||0:0,se=null!=(B=null==I?void 0:I[z])?B:0,ae=V+ne-se-ie,ce=V+re-se,ue=(0,a/* .within */.u)(_?(0,p/* .min */.VV)($,ae):$,V,_?(0,p/* .max */.Fp)(W,ce):W);T[z]=ue,N[z]=ue-V}if(b){var le,de="x"===z?r/* .top */.we:r/* .left */.t$,fe="x"===z?r/* .bottom */.I:r/* .right */.F2,pe=T[q],me="y"===q?"height":"width",he=pe+O[de],ve=pe-O[fe],ge=-1!==[r/* .top */.we,r/* .left */.t$].indexOf(j),be=null!=(le=null==I?void 0:I[q])?le:0,ye=ge?he:pe-P[me]-M[me]-be+A.altAxis,we=ge?pe+P[me]+M[me]-be-A.altAxis:ve,xe=_&&ge?(0,a/* .withinMaxClamp */.q)(ye,pe,we):(0,a/* .within */.u)(_?ye:he,pe,_?we:ve);T[q]=xe,N[q]=xe-pe}t.modifiersData[m]=N}},requiresIfExists:["offset"]};
/***/},
/***/83781:
/***/(e,t,n)=>{"use strict";
/* harmony export */n.d(t,{
...
/* harmony import */
// eslint-disable-next-line import/no-unused-modules
function f(e,t){void 0===t&&(t={});var n=t,f=n.placement,p=void 0===f?e.placement:f,m=n.boundary,h=void 0===m?c/* .clippingParents */.zV:m,v=n.rootBoundary,g=void 0===v?c/* .viewport */.Pj:v,b=n.elementContext,y=void 0===b?c/* .popper */.k5:b,w=n.altBoundary,x=void 0!==w&&w,k=n.padding,Z=void 0===k?0:k,_=(0,l/* ["default"] */.Z)("number"!=typeof Z?Z:(0,d/* ["default"] */.Z)(Z,c/* .basePlacements */.mv)),C=y===c/* .popper */.k5?c/* .reference */.YP:c/* .popper */.k5,S=e.rects.popper,O=e.elements[x?C:y],j=(0,r/* ["default"] */.Z)((0,u/* .isElement */.kK)(O)?O:O.contextElement||(0,o/* ["default"] */.Z)(e.elements.popper),h,g),E=(0,i/* ["default"] */.Z)(e.elements.reference),F=(0,s/* ["default"] */.Z)({reference:E,element:S,strategy:"absolute",placement:p}),z=(0,a/* ["default"] */.Z)(Object.assign({},S,F)),q=y===c/* .popper */.k5?z:E,T={top:j.top-q.top+_.top,bottom:q.bottom-j.bottom+_.bottom,left:j.left-q.left+_.left,right:q.right-j.right+_.right},P=e.modifiersData.offset;// Offsets can be applied only to the popper element
if(y===c/* .popper */.k5&&P){var M=P[p];Object.keys(T).forEach((function(e){var t=[c/* .right */.F2,c/* .bottom */.I].indexOf(e)>=0?1:-1,n=[c/* .top */.we,c/* .bottom */.I].indexOf(e)>=0?"y":"x";T[e]+=M[n]*t}))}return T}
/***/},
/***/8104:
/***/(e,t,n)=>{"use strict";
...
/* harmony import */var r=n(69307),o=n(65736),i=n(4981),s=n(55609),a=n(9818),c=n(52175),u=n(72067),l=n(12238),d=n(69973),f=n(52994),__=o.__,p=function(){return(0,d/* .getFirstBlockByName */.H4)("sensei-lms/quiz",(0,a.select)(c.store).getBlocks())},m=function(){return(0,d/* .getFirstBlockByName */.H4)("sensei-lms/quiz-question",(0,a.select)(c.store).getBlocks())},h=function(){var e=p();if(!e)return null;var t=(0,a.select)(c.store).getBlocks(e.clientId).find((function(e){return"boolean"===e.attributes.type}));return t||null},v=function(){var e=p();e&&(0,a.dispatch)(l.store).selectBlock(e.clientId)},g=function(){var e=m();e&&(0,a.dispatch)(l.store).selectBlock(e.clientId)},b=function(){var e=h();e&&(0,a.dispatch)(l.store).selectBlock(e.clientId)},y=function(){null===h()&&w()},w=function(){var e=p();e&&(0,(0,a.dispatch)(c.store).insertBlock)((0,i.createBlock)("sensei-lms/quiz-question",{type:"boolean"}),0,e.clientId)},x=function(e){
// Close answer feedback as the happy path next step.
if("adding-answer-feedback"!==e.slug){var t=document.querySelector(".sensei-lms-question-block__answer-feedback-toggle__header");
// Click to close only when it's open.
t&&document.querySelector(".wp-block-sensei-lms-quiz-question.show-answer-feedback")&&t.click()}
// Close sidebar if's a mobile viewport.
(window.innerWidth||document.documentElement.clientWidth)<782&&(0,(0,a.dispatch)(u.store).closeGeneralSidebar)()};
/* harmony import */
/**
 ...
 */
function k(){return[{slug:"welcome",meta:{heading:__("Welcome to the Quiz block","sensei-lms"),descriptions:{desktop:__("Take this short tour to learn the fundamentals of the Quiz block.","sensei-lms"),mobile:null},referenceElements:{desktop:""}},options:{classNames:{desktop:"",mobile:""}},referenceElements:{desktop:""},action:function(){(0,f/* .performStepActionsAsync */.Bm)([
// Focus on the Quiz block.
{action:function(){v()}},
// Highlight quiz block.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)(['[data-type="sensei-lms/quiz"]'])},delay:400}])}},{slug:"change-question-type",meta:{heading:__("Changing the question type","sensei-lms"),descriptions:{desktop:__("There are a variety of question types for you to choose from including Multiple Choice, True/False and File Upload. We’ll show how to configure a True/False question, but the other question types work similarly.","sensei-lms"),mobile:null}},options:{classNames:{desktop:"",mobile:""}},referenceElements:{desktop:""},action:function(){(0,f/* .performStepActionsAsync */.Bm)([
// Focus on question block.
{action:function(){g()}},
// Click on type selector.
{action:function(){var e=".sensei-lms-question-block__type-selector button",t=document.querySelector(e);(0,f/* .highlightElementsWithBorders */.QH)([e]),t&&t.click()},delay:400},
// Highlight options and select true/false type.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([".sensei-lms-question-block__type-selector__popover"]);var e=m();(0,a.dispatch)(c.store).updateBlockAttributes(e.clientId,{type:"boolean"})},delay:400}])}},{slug:"adding-a-question",meta:{heading:__("Adding a question","sensei-lms"),descriptions:{desktop:__("Click on an existing question to select it. Then type your question in the Question Title field.","sensei-lms"),mobile:null}},options:{classNames:{desktop:"",mobile:""}},action:function(){(0,f/* .performStepActionsAsync */.Bm)([
// Focus on question block.
{action:function(){g()}},
// Focus on title field.
{action:function(){var e=".sensei-lms-question-block__title .sensei-lms-single-line-input",t=document.querySelector(e);(0,f/* .highlightElementsWithBorders */.QH)([e]),t&&t.focus(),(0,f/* .scrollToCenter */.XT)(e)},delay:400}])}},{slug:"adding-question-description",meta:{heading:__("Adding a question description","sensei-lms"),descriptions:{desktop:__("Enter any additional details about the question in the Question Description. This is optional.","sensei-lms"),mobile:null}},options:{classNames:{desktop:"",mobile:""}},action:function(){var e=".wp-block-sensei-lms-question-description .rich-text";(0,f/* .performStepActionsAsync */.Bm)([
// Focus on question block.
{action:function(){g()}},
// Focus on description field.
{action:function(){var t=document.querySelector(e);t&&t.focus(),(0,f/* .scrollToCenter */.XT)(e)},delay:400},
// Highlight description field.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([e])},delay:400}])}},{slug:"setting-correct-answer",meta:{heading:__("Setting the correct answer","sensei-lms"),descriptions:{desktop:__("Click the Right or Wrong toggle to set the correct answer.","sensei-lms"),mobile:null}},options:{classNames:{desktop:"",mobile:""}},action:function(){(0,f/* .performStepActionsAsync */.Bm)([
// Focus on question block.
{action:function(){y(),b()}},
// Highlight and focus correct answer toggle.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([".sensei-lms-question-block__answer--true-false__option:nth-child(1) .sensei-lms-question-block__answer--true-false__toggle",".sensei-lms-question-block__answer--true-false__option:nth-child(2) .sensei-lms-question-block__answer--true-false__toggle"]);var e=document.querySelector(".sensei-lms-question-block__answer--true-false__toggle");e&&e.focus()},delay:400}])}},{slug:"adding-answer-feedback",meta:{heading:__("Adding answer feedback","sensei-lms"),descriptions:{desktop:__("Add feedback by opening the Answer Feedback section of the question block. This feedback is shown after the quiz has been graded.","sensei-lms"),mobile:null}},options:{classNames:{desktop:"",mobile:""}},action:function(){var e=".sensei-lms-question-block__answer-feedback-toggle__header";(0,f/* .performStepActionsAsync */.Bm)([
// Focus on question block.
{action:function(){y(),b()}},
// Highlight answer feedback.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([e])},delay:400},
// Open answer feedback.
{action:function(){var t=document.querySelector(e);
...
{action:function(){var e=".sensei-lms-question__answer-feedback__content .block-editor-rich-text__editable";document.querySelector(e).focus(),(0,f/* .scrollToCenter */.XT)(e),(0,f/* .highlightElementsWithBorders */.QH)([".sensei-lms-question__answer-feedback--correct",".sensei-lms-question__answer-feedback--incorrect"])},delay:400}])}},{slug:"adding-a-new-or-existing-question",meta:{heading:__("Adding a new or existing question","sensei-lms"),descriptions:{desktop:__("Click + to open the inserter. Then click the New Question or Existing Question(s) option.","sensei-lms"),mobile:null}},options:{classNames:{desktop:"",mobile:""}},action:function(){var e=".wp-block-sensei-lms-quiz .block-editor-inserter__toggle";(0,f/* .performStepActionsAsync */.Bm)([
// Focus on quiz block.
{action:function(){v()}},
// Click on the inserter.
{action:function(){var t=document.querySelector(e);t&&t.click()},delay:400},
// Highlight inserter button.
{action:function(){(0,f/* .scrollToCenter */.XT)(e),(0,f/* .highlightElementsWithBorders */.QH)([e])}},
// Highlight options.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([".components-dropdown-menu__popover"])},delay:400}])}},{slug:"configure-question-settings",meta:{heading:__("Configuring the question settings","sensei-lms"),descriptions:{desktop:(0,r.createInterpolateElement)(__("Question settings are available in the sidebar after selecting a question. View the <link_to_question_block_doc>doc</link_to_question_block_doc> to learn more about each one.","sensei-lms"),{link_to_question_block_doc:(0,r.createElement)(s.ExternalLink,{href:"https://senseilms.com/documentation/questions/#settings",children:null})}),mobile:null}},options:{classNames:{desktop:"",mobile:""}},action:function(){(0,f/* .performStepActionsAsync */.Bm)([
// Focus on question block.
{action:function(){g()}},
// Highlight question block and open sidebar settings.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([".wp-block-sensei-lms-quiz-question"]),(0,(0,a.dispatch)(u.store).openGeneralSidebar)("edit-post/block")},delay:400},
// Highlight sidebar.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([".block-editor-block-inspector .components-panel__body"],"inset")},delay:400}])}},{slug:"configure-quiz-settings",meta:{heading:__("Configuring the quiz settings","sensei-lms"),descriptions:{desktop:(0,r.createInterpolateElement)(__("Quiz settings are available in the sidebar after clicking the Quiz settings link. View the <link_to_quiz_block_doc>doc</link_to_quiz_block_doc> to learn more about each one.","sensei-lms"),{link_to_quiz_block_doc:(0,r.createElement)(s.ExternalLink,{href:"https://senseilms.com/documentation/quizzes/#quiz-settings",children:null})}),mobile:null}},options:{classNames:{desktop:"",mobile:""}},action:function(){var e=".sensei-lms-quiz-block__settings-quick-nav button";(0,f/* .performStepActionsAsync */.Bm)([
// Focus on quiz block.
{action:function(){v()}},
// Click on settings to open.
{action:function(){var t=document.querySelector(e);t&&(t.focus(),t.click())},delay:400},
// Highlight settings button.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([e])}},
// Highlight sidebar.
{action:function(){(0,f/* .highlightElementsWithBorders */.QH)([".sensei-lms-quiz-block__settings-wrapper"],"inset")},delay:400}])}},{slug:"congratulations",meta:{heading:__("Congratulations!","sensei-lms"),descriptions:{desktop:(0,r.createInterpolateElement)(__("You've mastered the basics. View the quiz <link_to_quiz_doc>docs</link_to_quiz_doc> to learn more","sensei-lms"),{link_to_quiz_doc:(0,r.createElement)(s.ExternalLink,{href:"https://senseilms.com/documentation/quizzes/",children:null})}),mobile:null}},options:{classNames:{desktop:"",mobile:""}},action:function(){
// Run the clean up.
...
/* harmony import */var e=n(66886),t=n(69307),r=n(9818),o=n(98817),i=n(69973),s=n(55512),a=n(72575),c="sensei-lesson-tour";
/* harmony import */function u(){var n=(0,r.useSelect)((function(e){var t=(0,e("core/block-editor").getBlocks)();return{quizBlock:(0,i/* .getFirstBlockByName */.H4)("sensei-lms/quiz",t)}})).quizBlock,o=(0,t.useState)((0,a/* ["default"] */.ZP)()),u=(0,e/* ["default"] */.Z)(o,1)[0];return n?(0,t.createElement)(s/* ["default"] */.Z,{trackId:"lesson_quiz_onboarding_step_complete",tourName:c,steps:u,beforeEach:a/* .beforeEach */.HF}):null}(0,o.registerPlugin)(c,{render:function(){return(0,t.createElement)(u,null)}})})()})
/******/();
...
/* harmony export */Z:()=>i
/* harmony export */});
/* harmony import */var s,r,o=t(99196);
/* harmony import */function l(){return l=Object.assign||function(e){for(var n=1;n<arguments.length;n++){var t=arguments[n];for(var s in t)Object.prototype.hasOwnProperty.call(t,s)&&(e[s]=t[s])}return e},l.apply(this,arguments)}
...
/* harmony import */var s=t(69307),r=t(65736),o=t(37798),l=t(72067),i=t(55609),c=t(33731);
/* harmony import */
/**
 ...
 */
const a=()=>{const[e,n]=(0,o.useEntityProp)("postType","course","meta"),{sensei_course_publish_lessons:t}=e;return(0,s.createElement)(l.PluginPrePublishPanel,{title:(0,r.__)("Sensei LMS","sensei-lms"),icon:(0,s.createElement)(c/* ["default"] */.Z,{height:"20",width:"20"}),initialOpen:!0},(0,s.createElement)(i.ToggleControl,{label:(0,r.__)("Publish lessons","sensei-lms"),help:(0,r.__)("Publish lessons when the course is published.","sensei-lms"),checked:t,onChange:t=>n({...e,sensei_course_publish_lessons:t})}))};

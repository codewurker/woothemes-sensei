...
/* harmony import */var r=t(69307),s=t(65736),o=t(37798),l=t(72067),i=t(12238),c=t(55609),a=t(33731);
/* harmony import */
/**
 ...
 */
const p=i.PluginPrePublishPanel||l.PluginPrePublishPanel,u=()=>{const[e,n]=(0,o.useEntityProp)("postType","course","meta"),{sensei_course_publish_lessons:t}=e;return(0,r.createElement)(p,{title:(0,s.__)("Sensei LMS","sensei-lms"),icon:(0,r.createElement)(a/* ["default"] */.Z,{height:"20",width:"20"}),initialOpen:!0},(0,r.createElement)(c.ToggleControl,{label:(0,s.__)("Publish lessons","sensei-lms"),help:(0,s.__)("Publish lessons when the course is published.","sensei-lms"),checked:t,onChange:t=>n({...e,sensei_course_publish_lessons:t})}))};
/**
 ...
 * Internal dependencies
 */
(0,e.registerPlugin)("sensei-course-pre-publish-panel-plugin",{render:n/* ["default"] */.Z,icon:null})})
/******/();
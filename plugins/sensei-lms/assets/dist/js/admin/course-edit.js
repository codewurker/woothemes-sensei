...
/* harmony export */Z:()=>r
/* harmony export */});
/* harmony import */var n,l,o=t(99196);
/* harmony import */function i(){return i=Object.assign||function(e){for(var s=1;s<arguments.length;s++){var t=arguments[s];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e},i.apply(this,arguments)}
...
/***/(e,s,t)=>{
/* harmony export */t.d(s,{
/* harmony export */Vw:()=>/* binding */i
/* harmony export */,H4:()=>/* binding */r
/* harmony export */});
/* unused harmony exports blockNames, blockTypes, syncStructureToBlocks, getCourseInnerBlocks */
/* harmony import */t(4981),t(9818)
/* harmony import */;var n=t(92819);
/**
 ...
 */
const l={module:"sensei-lms/course-outline-module",lesson:"sensei-lms/course-outline-lesson"},o=(0,n.invert)(l),i=((0,n.curry)(((e,s)=>{const{name:t,attributes:n}=s,l=Object.keys(o).includes(t),i="module"===e.type;return!!l&&(i?[e.title,e.lastTitle].includes(n.title):n.id?e.id===n.id:void 0)})),e=>{const s={module:e=>({description:e.attributes.description,lessons:i(e.innerBlocks),teacher:e.attributes.teacher,teacherId:e.attributes.teacherId,lastTitle:e.attributes.lastTitle,slug:e.attributes.slug}),lesson:e=>({draft:e.attributes.draft,preview:e.attributes.preview,initialContent:e.attributes.initialContent})};return e.map((e=>{const t=o[e.name];return{type:t,id:e.attributes.id,title:e.attributes.title,...s[t](e)}})).filter((e=>"module"===e.type||!!e.title))}),r=(e,s)=>{for(let t=0;t<s.length;t++){const n=s[t];if(e===n.name)return n;if(n.innerBlocks&&n.innerBlocks.length>0){const s=r(e,n.innerBlocks);if(s)return s}}return!1}}
/***/,
/***/25852:
/***/(e,s,t)=>{
/* harmony export */t.d(s,{
...
/* harmony export */Z:()=>i
/* harmony export */});
/* harmony import */var n=t(69307),l=t(55609),o=t(65736);
/* harmony import */
/**
 * WordPress dependencies
 */
 ...
 */
const i=()=>(0,n.createElement)(l.PanelBody,{title:(0,o.__)("Access Period","sensei-lms"),initialOpen:!0},(0,n.createElement)("div",{className:"sensei-course-access-period-promo"},(0,n.createElement)("p",null,(0,n.createElement)(l.ExternalLink,{href:"https://senseilms.com/sensei-pro/?utm_source=plugin_sensei&utm_medium=upsell&utm_campaign=course_access_period"},(0,o.__)("Upgrade to Sensei Pro","sensei-lms"))),(0,n.createElement)("div",{className:"sensei-course-access-period-promo__holder"},(0,n.createElement)("p",null,(0,o.__)("Set how long learners will have access to this course.","sensei-lms")),(0,n.createElement)(l.SelectControl,{label:(0,o.__)("Expiration","sensei-lms"),options:[{label:(0,o.__)("No expiration","sensei-lms")},{label:(0,o.__)("Expires after","sensei-lms")}]}))));
...
/* harmony export */Z:()=>a
/* harmony export */});
/* harmony import */var n=t(69307),l=t(65736),o=t(92694),i=t(81975),r=t(55609);
/* harmony import */
/**
 * WordPress dependencies
 */
...
/**
   ...
   */
const e=(0,o.applyFilters)("senseiCoursePricingDescription",(0,l.__)("Sell this course using WooCommerce - integrates with subscriptions, memberships, affiliates, and more.","sensei-lms"));return(0,n.createElement)(r.PanelBody,{title:(0,l.__)("Pricing","sensei-lms"),initialOpen:!0},(0,n.createElement)("p",null," ",(0,i.escapeHTML)(e)," "),(0,n.createElement)("p",null,(0,n.createElement)(r.ExternalLink,{href:"https://senseilms.com/sensei-pro/?utm_source=plugin_sensei&utm_medium=upsell&utm_campaign=course_pricing"},(0,l.__)("Upgrade to Sensei Pro","sensei-lms"))),(0,n.createElement)("p",{className:"sensei-pricing-promo__upgrade-new-course-text"},(0,l.__)("To access this course, learners will need to purchase one of the assigned products.","sensei-lms")),(0,n.createElement)("div",{className:"sensei-pricing-promo__upgrade-new-course"},(0,n.createElement)("p",{className:"sensei-pricing-promo__upgrade-new-course-text"},(0,l.__)("You don't have any products yet. Get started by creating a new WooCommerce product.","sensei-lms")),(0,n.createElement)(r.Button,{className:"sensei-pricing-promo__upgrade_new_course_mock_button",disabled:!0},(0,l.__)("Create a product","sensei-lms"))))};
/* harmony default export */}
/***/,
/***/28292:
/***/(e,s,t)=>{
...
/**
   ...
   */
const e=(0,l.applyFilters)("senseiCoursePricingHide",!1),s=(0,l.applyFilters)("senseiCourseAccessPeriodHide",!1);
/**
...
/***/(e,s,t)=>{
/* harmony export */t.d(s,{
/* harmony export */q6:()=>/* binding */n
/* harmony export */,kU:()=>/* binding */l
/* harmony export */});
/* unused harmony export SENSEI_PREVIEW_QUERY */
const n="sensei-theme",l="wordpress-theme"}
/***/,
/***/33735:
/***/(e,s,t)=>{
/* harmony export */t.d(s,{
...
/* harmony export */Z:()=>r
/* harmony export */});
/* harmony import */var n=t(69307),l=t(65736),o=t(55609),i=t(88698);
/* harmony import */
/**
 * WordPress dependencies
 */
 ...
 */
const r=()=>{const[e,s]=(0,i/* ["default"] */.Z)("sensei_course_video_autocomplete"),[t,r]=(0,i/* ["default"] */.Z)("sensei_course_video_autopause"),[a,c]=(0,i/* ["default"] */.Z)("sensei_course_video_required");return(0,n.createElement)(o.PanelBody,{title:(0,l.__)("Video","sensei-lms"),initialOpen:!0},(0,n.createElement)(o.ToggleControl,{label:(0,l.__)("Autocomplete lesson","sensei-lms"),checked:e,onChange:s,help:(0,l.__)("Complete lesson when video ends.","sensei-lms")}),(0,n.createElement)(o.ToggleControl,{label:(0,l.__)("Autopause","sensei-lms"),checked:t,onChange:r,help:(0,l.__)("Pause video when student navigates away.","sensei-lms")}),(0,n.createElement)(o.ToggleControl,{label:(0,l.__)("Required","sensei-lms"),checked:a,onChange:c,help:(0,l.__)("Video must be viewed before completing the lesson.","sensei-lms")}))};
/* harmony default export */}
/***/,
/***/88698:
/***/(e,s,t)=>{
 ...
 */
const l=e=>{const[s,t]=(0,n.useEntityProp)("postType","course","meta");return[s[e],s=>t({[e]:s})]};
/* harmony default export */}
/***/,
/***/41650:
/***/(e,s,t)=>{
 ...
 */
const l=e=>{let{subscribeListener:s=(()=>{}),onSetDirty:t=(()=>{}),onSaveStart:l=(()=>{}),onSave:o=(()=>{})}=e;const i=(0,n.select)("core/editor");let r=!1,a=!1;return(0,n.subscribe)((()=>{s();const e=i.isEditedPostDirty(),n=i.isSavingPost()&&!i.isAutosavingPost();!a&&e?(
...
e=c(9818),s=c(47701),t=c.n(s),n=c(98817),l=c(25852),o=c(69973),i=c(28292),
/**
 * WordPress dependencies
 */
/**
 * Internal dependencies
 */
(()=>{const s=(0,e.select)("core/edit-post"),t=(0,e.select)("core/editor"),n=document.getElementsByName("sensei-course-teacher-author"),l=document.getElementsByName("course_module_custom_slugs");if(s&&n.length){let i=!1;(0,e.subscribe)((()=>{if(t.isSavingPost()&&!t.isAutosavingPost()&&!s.isSavingMetaBoxes()&&l){const s=(0,o/* .getFirstBlockByName */.H4)("sensei-lms/course-outline",(0,e.select)("core/block-editor").getBlocks()),t=s&&(0,o/* .extractStructure */.Vw)(s.innerBlocks).filter((e=>e.slug)).map((e=>e.slug));l[0].value=JSON.stringify(t)}if(s.isSavingMetaBoxes()!==i&&(i=s.isSavingMetaBoxes(),!i)){const e=n[0].value;e&&(document.getElementsByName("post_author_override")[0].value=e)}}))}})(),t()((()=>{var e,s;(0,l/* .startBlocksTogglingControl */.F)("course"),jQuery("#course-prerequisite-options").select2({width:"100%"});const t=e=>s=>{var t={course_status:s.target.dataset.courseStatus};
...
null===(e=document.querySelector("a.add-course-lesson"))||void 0===e||e.addEventListener("click",t("course_add_lesson_click")),
// Log when the "Edit Lesson" link is clicked.
null===(s=document.querySelector("a.edit-lesson-action"))||void 0===s||s.addEventListener("click",t("course_edit_lesson_click"))})),
/**
 * Plugins
 */
(0,n.registerPlugin)(i/* .pluginSidebarHandle */.bM,{render:i/* .CourseSidebar */.jv}),(0,n.registerPlugin)(i/* .pluginDocumentHandle */.OR,{render:i/* .SenseiSettingsDocumentSidebar */.iB,icon:null})})
/******/();